...
public class DomainController extends GenericTableController {
    ...
    private static final Set<String> TABLES = Set.of("life_support_device","emergency_device_pool","emergency_device_allocation","special_device","leased_device","shared_device_loan","shared_device_return","shared_device_fee");
