...
public class DomainController extends GenericTableController {
    ...
    private static final Set<String> TABLES = Set.of("medical_device","device_accessory","device_entry","device_entry_item","device_outbound","device_outbound_item","device_return","device_return_item","device_goods_return","device_goods_return_item","asset_transfer","inventory_check","inventory_check_item","device_scrap","inspection_plan","inspection_record","inspection_record_item");
