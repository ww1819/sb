    ...
    public Result<Map<String, Object>> save(@RequestBody Map<String, Object> body) {
        ...
        if (!exists) {
            jdbc.update("""
                ...
                """, id, body.get("template_code"), body.get("template_name"), body.get("inspection_type_id"),
                    body.get("category_id"), body.get("description"), body.get("estimated_duration"),
            ...
            jdbc.update("""
                ...
                WHERE id=?::uuid
                """, body.get("template_code"), body.get("template_name"), body.get("inspection_type_id"),
                    body.get("category_id"), body.get("description"), body.get("estimated_duration"),
