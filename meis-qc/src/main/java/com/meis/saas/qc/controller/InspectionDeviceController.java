...
/**
 * 巡检设备管理：台账过滤视图（附录 O.5 / OPS.4 / OPS.13 / PLT-UI-02 / OPS.16.11）
 */
@RestController
...
public class InspectionDeviceController {
    ...
    public Result<PageResult<Map<String, Object>>> page(
        ...
        return Result.ok(OpsDevicePageSupport.page(
                jdbc, OpsDevicePageSupport.INSPECT, query,
    ...
    public void export(
        ...
        OpsDevicePageSupport.export(
                jdbc, OpsDevicePageSupport.INSPECT, resp, "ops_inspect_device_export.csv", query,
                device_status, dept_id, manage_dept_id,
                device_code, device_name, serial_number, specification, model, brand,
                due_within_days,
                category_id, asset_category_id, finance_category_id,
