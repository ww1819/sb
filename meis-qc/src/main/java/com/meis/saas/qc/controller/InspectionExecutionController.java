...
public class InspectionExecutionController {
    ...
    public Result<Map<String, Object>> updateHeader(@PathVariable UUID id, @RequestBody Map<String, Object> body) {
        ...
        SoftDeleteSupport.appendUpdateChannel(jdbc, "inspection_execution", sets, args, client);
    ...
    public Result<Map<String, Object>> patchItem(@PathVariable UUID itemId, @RequestBody Map<String, Object> body) {
        ...
        SoftDeleteSupport.appendUpdateChannel(jdbc, "inspection_execution_item", sets, args, client);
    ...
    private void touchItemUpdateChannel(UUID itemId, String client) {
        ...
        if (sets.isEmpty()) return;
        args.add(itemId);
        jdbc.update("UPDATE inspection_execution_item SET " + String.join(", ", sets) + " WHERE id=?::uuid", args.toArray());
    }
