...
public class InspectionPlanController {
    ...
    @Transactional
    @OperationLog(module = "inspect", description = "批量申请纳入巡检计划")
    public Result<Map<String, Object>> createIncludeRequestBatch(@RequestBody Map<String, Object> body) {
        return Result.ok(OpsPlanIncludeSupport.createBatch(jdbc, "inspect", body));
    }
    ...
    public Result<List<Map<String, Object>>> approvedPlansForInclude(
        ...
        return Result.ok(OpsPlanIncludeSupport.listEligiblePlans(
                jdbc, "inspect", deviceIds, keyword, dept_id, template_id, status, next_due_from, next_due_to));
    }
