...
public class MetrologyTemplateController {
    ...
    public Result<Map<String, Object>> get(@PathVariable UUID id) {
        ...
        result.put("items", jdbc.queryForList(
                "SELECT * FROM metrology_template_item WHERE template_id = ?::uuid ORDER BY sort_order, created_at", id));
    ...
    public Result<Map<String, Object>> save(@RequestBody Map<String, Object> body) {
        ...
        boolean exists = !jdbc.queryForList("SELECT 1 FROM metrology_template WHERE id = ?::uuid", id).isEmpty();
        ...
        if (!exists) {
            jdbc.update("""
                ...
                VALUES (?::uuid,?,?,?::uuid,?,?,?)
                """, id, body.get("template_code"), body.get("template_name"), body.get("category_id"),
            ...
            jdbc.update("""
                ...
                WHERE id=?::uuid
                """, body.get("template_code"), body.get("template_name"), body.get("category_id"),
