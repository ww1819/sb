...
| 版本 | 日期 | 作者 | 变更说明 |
|------|------|------|----------|
| 2.78 | 2026-07-22 18:55:00 | — | PLT-UI-02 二期：库房单据+运维计划/执行/记录状态·科室多选；PageableJdbc CSV→IN |
| 2.77 | 2026-07-22 18:50:00 | — | PLT-UI-02：列表检索多选+分类模糊拆分（一期五页）；约定包 v1.15 §5.5 |
| 2.76 | 2026-07-22 18:45:00 | — | W.6.4 P2 落地：采购/验收/执行结果/段工程师/巡检记录冗余 + dept_name 写点；BACKLOG-PLT-W03 完成 |
| 2.75 | 2026-07-22 18:30:00 | — | W.6.4 P1 落地：明细冗余列+历史回填+写点/查询；BACKLOG-PLT-W03 P1 已完成 |
