...
| 主题 | 位置 |
|------|------|
| **跨项目可复用约定全集** | [reusable-engineering-conventions.md](reusable-engineering-conventions.md)（**v1.26**） |
...
目前新增了很多功能，现在好多状态会以英文显示，请将英文转为中文显示，降低用户理解成本，包含web端，app端，小程序端
目前系统架构可否做I18N国际化？如果可以的话，请加到约定中

确认项
1.全三端
2.I18N先做约定+预留，本期不做语言切换。但是后续新增的功能和需求要为I18N保留架构和升级空间。后续我们如果要做I18N，很有可能会在本套代码里做改造，也可能利用现在的代码分离出一套来。我们会极大的概率在本套代码里做I18N升级改造，如果实在没有办法则才会根据本套代码再生成一套代码，请您给我们预留空间和专门架构优化
3.强制补齐字典，现阶段尽量
