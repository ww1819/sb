...
- [x] AST-UI-01 菜单「资产管理」更名为「资产登记」；列表隐藏勾选条（`hideSelectionBar`，保留勾选列供导出等）
...
| 版本 | 日期 | 作者 | 变更说明 |
|------|------|------|----------|
| 1.55 | 2026-07-15 22:29:58 | — | 资产台账菜单「资产管理」→「资产登记」；列表隐藏勾选条 AST-UI-01 |
...
| 主题 | 位置 |
|------|------|
| **跨项目可复用约定全集** | [reusable-engineering-conventions.md](reusable-engineering-conventions.md)（**v1.6**） |
