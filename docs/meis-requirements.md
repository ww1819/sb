...
| **资金 Tab** | 查询：资金来源；二级表头：序号/资金来源跨行；**期初 / 本期增加 / 本期减少 / 期末** 各组下「资产金额(元)、累计折旧(元)」；底栏合计 + 分页 |
| **分级 Tab** | 查询：资产分级；列：序号、资产分级、资产金额合计、累计折旧合计；同款底栏分页 |
| **状态 Tab** | 查询：折旧状态；列：序号、折旧状态、资产金额合计、累计折旧合计；同款底栏分页 |
