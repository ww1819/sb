...
| **下钻** | 行可打开同模块详情（路由或抽屉）；主从须见明细；多层见最底层 |
| **无详情页** | 至少只读抽屉展示头+明细 |
...
| 列表字典中文 / I18N 预留 | [附录 R](#附录-r列表状态与字典值中文显示)、[PLT-STATUS-CN-01](#plt-status-cn-01-三端状态枚举中文展示定稿2026-07-31)、[PLT-I18N-01](#plt-i18n-01-国际化架构预留定稿2026-07-31)、约定包 §5.1 / §5.13 |
