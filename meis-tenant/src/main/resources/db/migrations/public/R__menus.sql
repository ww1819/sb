...
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
INSERT INTO sys_menu (menu_code, parent_code, menu_name, menu_type, path, icon, sort_order, is_active) VALUES ('asset_device_license', 'asset_maint_mgmt', '设备证照', 'menu', '/asset/device-license', NULL, 4, TRUE)
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
INSERT INTO sys_menu (menu_code, parent_code, menu_name, menu_type, path, icon, sort_order, is_active) VALUES ('asset_device_training_auth', 'asset_maint_mgmt', '培训授权', 'menu', '/asset/device-training-auth', NULL, 5, TRUE)
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
...
ON CONFLICT (menu_code) DO UPDATE SET parent_code = EXCLUDED.parent_code, menu_name = EXCLUDED.menu_name, menu_type = EXCLUDED.menu_type, path = EXCLUDED.path, icon = EXCLUDED.icon, sort_order = EXCLUDED.sort_order, is_active = EXCLUDED.is_active;
INSERT INTO sys_menu (menu_code, parent_code, menu_name, menu_type, path, icon, sort_order, is_active) VALUES ('platform_service_health', 'mod_platform', '服务状态', 'menu', '/platform/service-health', NULL, 4, TRUE)
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
...
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
INSERT INTO sys_menu (menu_code, parent_code, menu_name, menu_type, path, icon, sort_order, is_active) VALUES ('analytics_asset_occupy', 'analytics_asset_report_group', '资产在用统计', 'menu', '/analytics/asset-occupy', NULL, 9, TRUE)
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
...
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
INSERT INTO sys_menu (menu_code, parent_code, menu_name, menu_type, path, icon, sort_order, is_active) VALUES ('analytics_asset_transfer', 'analytics_asset_report_group', '资产移动统计表', 'menu', '/analytics/asset-transfer', NULL, 10, TRUE)
ON CONFLICT (menu_code) DO UPDATE SET parent_code=EXCLUDED.parent_code, menu_name=EXCLUDED.menu_name, menu_type=EXCLUDED.menu_type, path=EXCLUDED.path, icon=EXCLUDED.icon, sort_order=EXCLUDED.sort_order, is_active=EXCLUDED.is_active;
