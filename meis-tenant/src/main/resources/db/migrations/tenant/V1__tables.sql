...
CREATE TABLE purchase_plan_item (
    ...
    bargain_meeting_conclusion TEXT,
    bargain_record_url VARCHAR(500),
    bargain_review_result VARCHAR(20),
    bargain_review_comment VARCHAR(500),
    bargain_reviewed_at TIMESTAMPTZ,
