<template>
  <div class="pm-execution-page">
    ...
    <AppModal v-model="itemVisible" title="设备PM执行" size="lg">
...
const config = getPageConfig('/pm/execution')!
