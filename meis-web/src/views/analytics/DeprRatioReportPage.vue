    ...
    <template v-if="activeTab === 'detail'">
      ...
      <div class="table-wrap">
        ...
        >
          ...
          <el-table-column prop="device_code" label="设备编号" min-width="130" sortable="custom" />
          <el-table-column prop="asset_name" label="资产名称" min-width="160" show-overflow-tooltip sortable="custom" />
          <el-table-column prop="specification" label="规格/型号" min-width="140" show-overflow-tooltip />
          <el-table-column prop="unit" label="单位" width="70" align="center" />
          <el-table-column prop="use_dept" label="使用科室" min-width="120" show-overflow-tooltip sortable="custom" />
          <el-table-column prop="monthly_rate" label="月折旧率(%)" min-width="130" align="right" sortable="custom" />
          <el-table-column prop="monthly_amount" label="月折旧金额（元）" min-width="168" align="right" sortable="custom" />
          <el-table-column prop="original_value" label="原值（元）" min-width="140" align="right" sortable="custom" />
          <el-table-column prop="accum_depr" label="累计折旧金额（元）" min-width="172" align="right" />
          <el-table-column prop="net_value" label="净值（元）" min-width="140" align="right" />
          <el-table-column prop="purchase_date" label="购入日期" min-width="120" align="center" />
          <el-table-column prop="depr_dept" label="折旧科室" min-width="120" show-overflow-tooltip />
          <el-table-column prop="depr_ratio" label="折旧比例" min-width="100" align="right" />
          <el-table-column prop="depr_months" label="已折旧月份" min-width="110" align="right" />
          <el-table-column prop="storage_place" label="存放地点" min-width="140" show-overflow-tooltip />
        </el-table>
...
.table-wrap :deep(.el-scrollbar__bar.is-horizontal .el-scrollbar__thumb) {
  background-color: #c0c4cc;
  border-radius: 4px;
  opacity: 1;
}

.table-wrap :deep(.el-scrollbar__bar.is-horizontal .el-scrollbar__thumb:hover) {
  background-color: #a8abb2;
}

.table-wrap :deep(.el-table__body-wrapper) {
  scrollbar-width: thin;
  scrollbar-color: #c0c4cc #ebeef5;
}

.table-wrap :deep(.el-table__body-wrapper)::-webkit-scrollbar {
  height: 8px;
  width: 8px;
}

.table-wrap :deep(.el-table__body-wrapper)::-webkit-scrollbar-track {
  background: #ebeef5;
}

.table-wrap :deep(.el-table__body-wrapper)::-webkit-scrollbar-thumb {
  background: #c0c4cc;
  border-radius: 4px;
}

.table-wrap :deep(.el-table__body-wrapper)::-webkit-scrollbar-thumb:hover {
  background: #a8abb2;
}
