...
const pageMap: Record<string, ReturnType<typeof defineAsyncComponent>> = {
  ...
  '/analytics/asset-usage': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/value-structure': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/depr-due': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/depr-stats': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/depr-ratio': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/depr-detail': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/asset-change': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/asset-occupy': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/asset-transfer': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
