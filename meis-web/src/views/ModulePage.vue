...
const pageMap: Record<string, ReturnType<typeof defineAsyncComponent>> = {
  ...
  '/asset/dynamic-stats': defineAsyncComponent(() => import('@/views/asset/AssetDynamicStatsPage.vue')),
  '/asset/dept-inventory-apply': defineAsyncComponent(() => import('@/views/asset/DeptInventoryApplyPage.vue')),
  ...
  '/asset/warranty-term': defineAsyncComponent(() => import('@/views/asset/DeviceWarrantyPage.vue')),
  ...
  '/maintain/device': defineAsyncComponent(() => import('@/views/maintain/MaintainDevicePage.vue')),
  ...
  '/inspect/device': defineAsyncComponent(() => import('@/views/inspect/InspectDevicePage.vue')),
  ...
  '/dict/asset-category': defineAsyncComponent(() => import('@/views/dict/AssetCategoryPage.vue')),
  ...
  '/warehouse/scrap-review': defineAsyncComponent(() => import('@/views/warehouse/ScrapReviewPage.vue')),
  '/warehouse/scrap-query': defineAsyncComponent(() => import('@/views/warehouse/ScrapQueryPage.vue')),
  ...
  '/analytics/charge-audit': defineAsyncComponent(() => import('@/views/analytics/ChargeAuditPage.vue')),
  ...
  '/analytics/asset-usage': defineAsyncComponent(() => import('@/views/analytics/AssetUsageReportPage.vue')),
  '/analytics/value-structure': defineAsyncComponent(() => import('@/views/analytics/ValueStructureReportPage.vue')),
  '/analytics/depr-due': defineAsyncComponent(() => import('@/views/analytics/DeprDueReportPage.vue')),
  '/analytics/depr-stats': defineAsyncComponent(() => import('@/views/analytics/DeprStatsReportPage.vue')),
  '/analytics/depr-ratio': defineAsyncComponent(() => import('@/views/analytics/DeprRatioReportPage.vue')),
  '/analytics/depr-detail': defineAsyncComponent(() => import('@/views/analytics/AssetReportPlaceholderPage.vue')),
  '/analytics/asset-change': defineAsyncComponent(() => import('@/views/analytics/AssetChangeReportPage.vue')),
  '/analytics/asset-occupy': defineAsyncComponent(() => import('@/views/analytics/AssetOccupyReportPage.vue')),
  '/analytics/asset-transfer': defineAsyncComponent(() => import('@/views/analytics/AssetTransferReportPage.vue')),
