import{d as Le,m as Oe,r as k,ae as Pe,o as E,c as Ee,f as n,w as i,s as Ie,A as Q,i as c,z as w,x as Ye,e as d,p as Ae,y as He,j as u,k as We,a0 as I,E as m,ad as Ze,G as Ge,_ as Je}from"./index-Dr59-LAb.js";import{S as Ke}from"./SystemPageCard-DQ-RFZwI.js";import{T as F,a as Qe,P as Xe,b as re,u as et,d as tt,p as at}from"./ModulePage-DsICn_G8.js";import"./pageRegistry-aAM-mZFE.js";import"./PageEmpty-C65QW5Qp.js";import"./useSystemTableHeight-C0DoJFjH.js";function X(g){return g.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function se(g,f){const v=g==null?"":String(g).trim(),b=v?X(v).replace(/\n/g,"<br/>"):"&nbsp;";return`<div class="box" style="height:${f}px;min-height:${f}px;line-height:1.6;">${b}</div>`}function Y(g){const f=g==null?"":String(g).trim();return f?X(f):"&nbsp;"}function be(g,f){const v="设备购置询价议价会议记录",b=f==="word",h=130,T=170,V=170,C=b?`<!--[if gte mso 9]><xml>
<w:WordDocument>
  <w:View>Print</w:View>
  <w:Zoom>100</w:Zoom>
